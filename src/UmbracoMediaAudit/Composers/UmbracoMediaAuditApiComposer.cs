...
namespace UmbracoMediaAudit.Composers
{
    public class UmbracoMediaAuditApiComposer : IComposer
    {
        ...
        {
            // Singletons: MediaAuditService caches the last audit run/results in memory for the
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("UmbracoMediaAudit.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
